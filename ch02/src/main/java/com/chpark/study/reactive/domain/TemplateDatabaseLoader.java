...
public class TemplateDatabaseLoader {
    ...
    CommandLineRunner initialize(MongoOperations mongoOperations) {
        ...
        return (args) -> {
            mongoOperations.save(new Item("MackBookPro","Apple's Mackboo Pro 15inch!",  2_000_000));
            ...
            mongoOperations.save(new Item("Keyboard", "Keychone bluetooth keyboard",  120_000));
       };
    }
}
